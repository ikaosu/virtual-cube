/*
 * Modified from cstimer (github.com/cs0x7f/cstimer, GPLv3) for the
 * virtual-cube project on 2026-04-26.
 *
 * Modifications:
 *  - Removed automatic ServiceWorker / applicationCache registration block
 *    (originally at lines 274-287) — this app does not use a service worker,
 *    and there is no /sw.js to serve.
 */
'use strict';
...
ISCSTIMER && execMain(function() {
	...
	// [virtual-cube modification] removed ServiceWorker / applicationCache
	// auto-registration. Original logic referenced cstimer's sw.js which
